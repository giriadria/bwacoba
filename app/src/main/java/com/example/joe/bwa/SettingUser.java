...
public class SettingUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameText.setText(prof.getStringExtra("namauser"));
        }
                ...
                sRef.putFile(filePath)
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                Toast.makeText(SettingUser.this, "Save Success ", Toast.LENGTH_LONG).show();
                                sharedPref = getPreferences(MODE_PRIVATE);
                                //creating the upload object to store uploaded image details
                                progressDialog.setMessage("Tunggu...");
                                progressDialog.show();
                                startActivity(new Intent(SettingUser.this,ProfileActivity.class));
                                finish();
                                ...
                                uploads.put("namauser",userNameText.getText().toString());
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception exception) {
                                progressDialog.dismiss();
                                Toast.makeText(SettingUser.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        })
